          ...
          <>
            ...
            {draftBeats.length > 0 && (
              <div className="mb-8">
                <div className="flex items-center gap-2 mb-4">
                  <h2 className="heading-responsive-md">Drafts</h2>
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-muted-foreground text-xs">
                  {publishedBeats.length} {publishedBeats.length === 1 ? 'beat' : 'beats'}
                </span>
              </div>
              {publishedBeats.length > 0 ? (
                ...
                <Card className="border border-dashed bg-muted/30">
                  <CardContent className="flex flex-col items-center justify-center py-10 text-center">
                    ...
                    <h2 className="heading-responsive-sm mb-2">No Published Beats</h2>
                    <p className="text-sm text-muted-foreground max-w-md mb-5">
                      You haven't published any beats yet. Upload or publish a beat to get started!
                    </p>
                    <Button 
                      onClick={() => navigate('/producer/upload')}
                      className="gap-1.5"

    ...
    return (
      <aside
        className={cn(
          ...
          // Dark background, remove default border
            ...
            <div key={index} className="mb-6">
              ...
              <nav className="flex flex-col gap-1">
                {section.items.map((item, idx) => {
                  return item.onClick ? (
                    <TooltipProvider
                      delayDuration={isCollapsed ? 100 : 1000}
                      key={idx}
                    >
                      <Tooltip>
                          ...
                          <NavLink
                            ...
                            className={({ isActive }) =>
                              cn(
                                ...
                                "hover:bg-purple-500/20",
                                isActive
                                  ? "border-l-4 border-purple-500 bg-[#181818] text-purple-400 font-medium"
                                  : "text-gray-400 hover:text-white",
                                isCollapsed ? "justify-center" : ""
                              )
                            }
                          >
                            {/* Icon color toggles if active */}
                            <item.icon
                              size={18}
                              className={cn(
                                "transition-colors",
        ...
        <>
          <aside
            className={cn(
              ...
              // Dark background, remove default borders
              "bg-[#0e0e0e] text-white",

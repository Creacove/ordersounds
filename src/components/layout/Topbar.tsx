...
import { Search, ShoppingCart, User, Bell, LogOut, Settings, MessageSquare, LogIn, UserPlus, Music, Heart, Home } from "lucide-react";
import { 
  DropdownMenu, 
  DropdownMenuContent, 
  DropdownMenuItem, 
      ...
      <div className="flex h-16 items-center px-4 md:px-6">
        <Link to="/" className="flex items-center gap-2 mr-4">
          <div className="flex items-center gap-1">
            ...
            <span className="text-lg font-semibold">OrderSOUNDS</span>
          </div>
        </Link>
